...
import dao.DefaultCheckingAccountDAO;
...
public class DefaultPersonalCheckingAccountController implements IController {
	...
	public void add(IView viewSender) {
		try {
			...
			if(DefaultCheckingAccountDAO.getAccountByAccountNumber(accountNumber) != null) {
